...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, ReservationMessage> consumerFactory() {
		...
		props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, ReservationEvent.class.getName());
		return new DefaultKafkaConsumerFactory<>(props);
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ReservationMessage> concurrentKafkaListenerContainerFactory() {
